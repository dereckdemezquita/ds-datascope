...
data$merged %>%
	...
	labs(title = "World population per country", subtitle = "Coloured per region", caption = "Red dotted line: projected", x = "Year", y = "Population", colour = "Region")
...
data$merged %>%
	...
	theme(legend.position = "bottom", axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1)) +
	guides(colour = guide_legend(override.aes = list(alpha = 0.75))) + # make alpha coloured legend darker
	labs(title = "World population per country", subtitle = "Coloured per region", caption = "Red dotted line: projected", x = "Year", y = "log2(Population)", colour = "Region")
```
...
data$merged %>%
	...
	guides(colour = guide_legend(override.aes = list(alpha = 0.75))) + # make alpha coloured legend darker
	labs(title = "World population per country", subtitle = "Faceted per region", caption = "Red dotted line: projected", x = "Year", y = "Population", colour = "Region") +
...
data$merged %>%
	...
	theme(legend.position = "none", axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1), panel.grid.minor = element_blank()) +
	guides(colour = guide_legend(override.aes = list(alpha = 0.75))) + # make alpha coloured legend darker
	labs(title = "World population per country", subtitle = "Faceted per region", caption = "Red dotted line: projected", x = "Year", y = "log2(Population)", colour = "Region") +
	facet_wrap(~ region7geoEU, scales = "free")
```
...
data$merged %>%
	...
	labs(title = "World population aggregated per region", subtitle = "Coloured per region", caption = "Red dotted line: projected", x = "Year", y = "Population", colour = "Region")
...
data$merged %>%
	...
	theme(legend.position = "none", axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1)) +
	labs(title = "Total world population", caption = "Red dotted line: projected", x = "Year", y = "Population - Billions") 
...
data$merged %>%
	...
	theme(legend.position = "none", axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1)) +
	labs(title = "Total world population", caption = "Red dotted line: projected", x = "Year", y = "log2(Population - Billions)")
```
...
data$merged %>%
	...
	labs(title = "GDP per country", subtitle = "Coloured by region", caption = "Constant 2005 international dollars", x = "Year", y = "Total GDP", colour = "Region")
...
data$merged %>%
	...
	guides(color = guide_legend(override.aes = list(alpha = 0.95))) +
	theme(legend.position = "bottom", axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1), legend.title = element_text(vjust = 0.5)) +
	labs(title = "GDP per country", subtitle = "Coloured by region", caption = "Constant 2005 international dollars", x = "Year", y = "log2(Total GDP)", colour = "Region")
```
...
data$merged %>%
	...
	theme(legend.position = "none", axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1), panel.grid.minor = element_blank()) +
	labs(title = "GDP per country", caption = "Constant 2005 international dollars", x = "Year", y = "log2(Total GDP)", colour = "Region") +
	facet_wrap(~ region7geoEU, scales = "free")
...
data$merged %>%
	...
	guides(color = guide_legend(override.aes = list(alpha = 0.95))) +
	theme(legend.position = "bottom", axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1), legend.title = element_text(vjust = 0.5)) +
	labs(title = "GDP/income income per capita per country", subtitle = "Coloured by region", caption = "Constant 2011 international dollars", x = "Year", y = "GDP/income per capita", colour = "Region")
...
data$merged %>%
	...
	guides(color = guide_legend(override.aes = list(alpha = 0.95))) +
	theme(legend.position = "bottom", axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1), legend.title = element_text(vjust = 0.5)) +
	labs(title = "GDP/income income per capita per country", subtitle = "Coloured by region", caption = "Constant 2011 international dollars", x = "Year", y = "log2(GDP/income per capita)", colour = "Region")
```
...
data$merged %>%
	...
	theme(legend.position = "none", axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1), panel.grid.minor = element_blank()) +
	labs(title = "GDP/income income per capita per region", caption = "Constant 2011 international dollars", x = "Year", y = "GDP/income per capita", colour = "Region") +
	facet_wrap(~ region7geoEU, scales = "free")
...
data$merged %>%
	...
	theme(legend.position = "none", axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1), panel.grid.minor = element_blank()) +
	labs(title = "GDP/income income per capita per region", caption = "Constant 2011 international dollars", x = "Year", y = "log2(GDP/income per capita)", colour = "Region") +
	facet_wrap(~ region7geoEU, scales = "free")
```
...
data$merged %>%
	...
	labs(title = "Average life expectancy per country", subtitle = "Coloured by region", x = "Year", y = "Average life expectancy", colour = "Region")
```
...
data$merged %>%
	...
	guides(colour = guide_legend(override.aes = list(alpha = 0.95))) +
	theme(legend.position = "bottom", axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1), panel.grid.minor = element_blank(), legend.title = element_text(vjust = 0.5)) +
	labs(title = "Average life expectancy per region", subtitle = "Coloured by region", x = "Year", y = "Average life expectancy", colour = "Region")
```
...
data$merged %>%
	...
	guides(colour = guide_legend(override.aes = list(alpha = 0.95))) +
	theme(legend.position = "bottom", axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1), panel.grid.minor = element_blank(), legend.title = element_text(vjust = 0.5)) +
	labs(title = "Gini per country (inequality index)", subtitle = "A higher number means more inequality", x = "Year", y = "Gini index value", colour = "Region")
```
...
data$merged %>%
	...
	theme(legend.position = "none", axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1), panel.grid.minor = element_blank()) +
	labs(title = "Total number of children per region: 0 - 5 yrs", x = "Year", y = "Number") +
	facet_wrap(~ region7geoEU, scales = "free")
...
data$merged %>% 
	...
	theme(legend.position = "bottom", axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1), legend.title = element_text(vjust = 0.5)) +
	labs(title = "Percentage to country's population of children 0 - 5 yrs", subtitle = "Coloured by region", x = "Year", y = "Percent of children under 5 yrs", colour = "Region")
```
...
data$merged %>%
	...
	theme(legend.position = "bottom", axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1), legend.title = element_text(vjust = 0.5)) +
	labs(title = "Number of countries at least one female head of state", subtitle = "Coloured per region", x = "Year", y = "Number of countries at least one female head of state", fill = "Region")
```
...
data$merged %>%
	...
	labs(title = "Percentage of women to parliaments per country", subtitle = "Coloured by region", x = "Year", y = "Percent of women in parliaments", colour = "Region")
```
